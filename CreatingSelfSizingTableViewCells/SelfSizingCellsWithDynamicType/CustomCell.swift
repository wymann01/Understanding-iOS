...
class CustomCell: UITableViewCell {
    ...
    private func setUpLabelsAndConstraints() {
        ...
        bottomView.leadingAnchor.constraint(equalTo: headlineLabel.leadingAnchor).isActive = true
        bottomView.trailingAnchor.constraint(equalTo: headlineLabel.trailingAnchor).isActive = true
        bottomView.heightAnchor.constraint(equalToConstant: 66).isActive = true
        bottomView.widthAnchor.constraint(equalToConstant: 55).isActive = true
         ...
         */
        // 以下约束都是利用了NSLayoutAnchor 中的 firstBaselineAnchor 和 lastBaselineAnchor
        // 不是 Label 相关的View 也能用,比如 UIView
        // 添加顶部的约束
        ...
        contentView.layoutMarginsGuide.bottomAnchor.constraint(equalToSystemSpacingBelow: bottomView.lastBaselineAnchor, multiplier: 1).isActive = true
        ...
        bottomView.firstBaselineAnchor.constraint(equalToSystemSpacingBelow: bodyLabel.lastBaselineAnchor, multiplier: 1).isActive = true
        ...
        /*
         ...
         Launch Xcode, then run your app.

         From the Xcode menu bar, select Xcode > Open Developer Tool > Accessibility Inspector to launch the inspector.

         In the upper left corner of the Accessibility Inspector, select Simulator as the target.

         Click the Settings icon (shaped like a gear).

         Move the Font size slider to change the size of text displayed in your app.
         */
    }
}
